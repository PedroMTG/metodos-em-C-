...
{ 
    ...
    {
       public void heapsortCrescente(int[] vet, int N)
        {
            int i, aux;
       ...
       public void criaHeapCrescente(int[] vet, int i, int f) //i= inicio do vetor && f= fim do vetor
        {
    ...
    class Program2
    {
        ...
        {
            Ordenar2 vetor = new Ordenar2();
            int[] vet = { 10, 64, 7, 99, 32, 18 };
            int n = vet.Length;

            
            vetor.heapsortCrescente(vet, n);
